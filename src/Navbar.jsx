            ...
            <div className="container row">
                ...
                <div className="nav_list sm_row">
                    ...
                    <div className="sm_item">
                        <svg onClick={() => setIsVisible(true)}  xmlns="http://www.w3.org/2000/svg" className='menu' height="24px" viewBox="0 -960 960 960" width="24px" fill="#5f6368"><path d="M120-240v-80h720v80H120Zm0-200v-80h720v80H120Zm0-200v-80h720v80H120Z"/></svg>
                    </div>
                </div>
                <nav className={navClassName}>
                    <ul className="nav_list nav_list__lg ">
                        ...
                        <li className="nav_item"><Link to='/blogs' className="nav_link">Blogs</Link></li>
