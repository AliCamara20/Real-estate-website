const estateLocations = ['Brooklyn', 'California', 'Dunao', 'Liverpool',
    'London',   'Los Angeles', 'Louisiana', 'New Orleans', 'New York', 
    'Queens', 'San Francisco', 'United Kingdom'
];

const EstateLocations = () => {

    const panelItems   = estateLocations.map( (location, index) => {
        return(
...
export default EstateLocations